...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_FAIRY_REFILL,               "a",    "Fairy",                      ITEM_FAIRY,                      GI_FAIRY,                    GID_FAIRY_2),
    ...
    RI(RI_MASK_ALL_NIGHT,             "the",  "All-Night Mask",             ITEM_MASK_ALL_NIGHT,             GI_MASK_ALL_NIGHT,           GID_MASK_ALL_NIGHT),
    ...
    RI(RI_MASK_COUPLE,                "the",  "Couples Mask",               ITEM_MASK_COUPLE,                GI_MASK_COUPLE,              GID_MASK_COUPLE),
    RI(RI_MASK_DEKU,                  "the",  "Deku Mask",                  ITEM_MASK_DEKU,                  GI_MASK_DEKU,                GID_MASK_DEKU),
    RI(RI_MASK_GARO,                  "",     "Garo's Mask",                ITEM_MASK_GARO,                  GI_MASK_GARO,                GID_MASK_GARO),
    ...
    RI(RI_OWL_CLOCK_TOWN_SOUTH,       "the",  "Clock Town Warpstone",       ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_GREAT_BAY_COAST,        "the",  "Great Bay Coast Warpstone",  ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_IKANA_CANYON,           "the",  "Ikana Canyon Warpstone",     ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_MILK_ROAD,              "the",  "Milk Road Warpstone",        ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_MOUNTAIN_VILLAGE,       "the",  "Mountain Village Warpstone", ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_SNOWHEAD,               "the",  "Snowhead Warpstone",         ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_SOUTHERN_SWAMP,         "the",  "Southern Swamp Warpstone",   ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_STONE_TOWER,            "the",  "Stone Tower Warpstone",      ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_WOODFALL,               "the",  "Woodfall Warpstone",         ITEM_NONE,                       GI_NONE,                     GID_NONE),
    RI(RI_OWL_ZORA_CAPE,              "the",  "Zora Cape Warpstone",        ITEM_NONE,                       GI_NONE,                     GID_NONE),
    ...
    RI(RI_PROGRESSIVE_SWORD,          "a",    "Progressive Sword",          ITEM_NONE,                       GI_NONE,                     GID_SWORD_KOKIRI),
    RI(RI_PROGRESSIVE_WALLET,         "a",    "Progressive Wallet",         ITEM_NONE,                       GI_NONE,                     GID_WALLET_ADULT),
    ...
    RI(RI_SONG_BOSSA_NOVA,            "the",  "New Wave Bossa Nova",        ITEM_SONG_NOVA,                  GI_NONE,                     GID_NONE),
    ...
    RI(RI_SWORD_KOKIRI,               "the",  "Kokiri Sword",               ITEM_SWORD_KOKIRI,               GI_SWORD_KOKIRI,             GID_SWORD_KOKIRI),
    ...
    RI(RI_WALLET_GIANT,               "the",  "Giant's Wallet",             ITEM_WALLET_GIANT,               GI_WALLET_GIANT,             GID_WALLET_GIANT),
