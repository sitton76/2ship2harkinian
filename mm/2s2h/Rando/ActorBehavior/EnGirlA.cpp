...
s32 EnGirlA_RandoCanBuyFunc(PlayState* play, EnGirlA* enGirlA) {
    ...
    // Probably need to have a more robust check here but this effectively checks if the player can receive the item for now
    if (randoSaveCheck.randoItemId != RI_RUPEE_BLUE && Rando::ConvertItem(randoSaveCheck.randoItemId) == RI_RUPEE_BLUE) {
...
RandoCheckId IdentifyShopItem(Actor* actor) {
    switch (gPlayState->sceneId) {
        case SCENE_8ITEMSHOP:
            switch (actor->params) {
                case 10: return RC_TRADING_POST_SHOP_ITEM_1;
                case 5: return RC_TRADING_POST_SHOP_ITEM_2;
                case 6: return RC_TRADING_POST_SHOP_ITEM_3;
                case 3: return RC_TRADING_POST_SHOP_ITEM_4;
                case 7: return RC_TRADING_POST_SHOP_ITEM_5;
                case 8: return RC_TRADING_POST_SHOP_ITEM_6;
                case 9: return RC_TRADING_POST_SHOP_ITEM_7;
                case 4: return RC_TRADING_POST_SHOP_ITEM_8;
            }
            break;
        case SCENE_BOMYA:
            switch (actor->params) {
                case 26: return RC_BOMB_SHOP_ITEM_1;
                case 25: return RC_BOMB_SHOP_ITEM_2;
                case 23: return RC_BOMB_SHOP_ITEM_3;
            }
            break;
        case SCENE_WITCH_SHOP:
            switch (actor->params) {
                case 2: return RC_HAGS_POTION_SHOP_ITEM_1;
                case 1: return RC_HAGS_POTION_SHOP_ITEM_2;
                case 0: return RC_HAGS_POTION_SHOP_ITEM_3;
            }
            break;
        case SCENE_GORONSHOP:
            switch (actor->params) {
                case 30: return RC_GORON_SHOP_ITEM_1;
                case 31: return RC_GORON_SHOP_ITEM_2;
                case 32: return RC_GORON_SHOP_ITEM_3;
            }
            break;
        case SCENE_BANDROOM:
            switch (actor->params) {
                case 27: return RC_ZORA_SHOP_ITEM_1;
                case 28: return RC_ZORA_SHOP_ITEM_2;
                case 29: return RC_ZORA_SHOP_ITEM_3;
            }
            break;
    }
...
void Rando::ActorBehavior::InitEnGirlABehavior() {
    ...
    GameInteractor::Instance->RegisterGameHookForID<GameInteractor::OnOpenText>(
        RANDO_DESC_TEXT_ID, [](u16* textId, bool* loadFromMessageTable) {
            ...
            CustomMessage::Replace(&entry.msg, "Red Potion: 20 Rupees", std::string(randoStaticItem.name) + ": 20 Rupees");
