...
std::unordered_map<RandoRegionId, RandoRegion> Regions = {
    ...
    { RR_GORON_SHRINE, RandoRegion{ .sceneId = SCENE_16GORON_HOUSE,
        .checks = {
            CHECK(RC_GORON_SHRINE_POT_1, true),
            CHECK(RC_GORON_SHRINE_POT_2, true),
            CHECK(RC_GORON_SHRINE_POT_3, true),
            CHECK(RC_GORON_SHRINE_POT_4, true),
            CHECK(RC_GORON_SHRINE_POT_5, true),
            CHECK(RC_GORON_SHRINE_POT_6, true),
            CHECK(RC_GORON_SHRINE_POT_7, true),
            CHECK(RC_GORON_SHRINE_POT_8, true),
            CHECK(RC_GORON_SHRINE_POT_9, true),
    ...
    { RR_GORON_RACETRACK, RandoRegion{ .sceneId = SCENE_GORONRACE,
        .checks = {
            // TODO : Add Gold dust in bottle check.
            CHECK(RC_GORON_RACETRACK_POT_1, true),
            CHECK(RC_GORON_RACETRACK_POT_2, true),
            CHECK(RC_GORON_RACETRACK_POT_3, true),
            CHECK(RC_GORON_RACETRACK_POT_4, true),
            CHECK(RC_GORON_RACETRACK_POT_5, true),
            CHECK(RC_GORON_RACETRACK_POT_6, true),
            CHECK(RC_GORON_RACETRACK_POT_7, true),
            CHECK(RC_GORON_RACETRACK_POT_8, true),
            CHECK(RC_GORON_RACETRACK_POT_9, true),
    ...
    { RR_GORON_SHOP, RandoRegion{ .sceneId = SCENE_GORONSHOP,
        .checks = {
    ...
    { RR_GORON_VILLAGE, RandoRegion{ .sceneId = SCENE_11GORONNOSATO,
        .checks = {
