...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_OCEAN_SPIDER_HOUSE_CENTRAL_ROOM] = RandoRegion{ .name = "Central Room", .sceneId = SCENE_KINDAN2,
        .checks = {
            CHECK(RC_OCEAN_SKULLTULA_2ND_ROOM_BEHIND_SKULL_01, HAS_ITEM(ITEM_HOOKSHOT) || CAN_BE_ZORA),
            CHECK(RC_OCEAN_SKULLTULA_2ND_ROOM_BEHIND_SKULL_02, HAS_ITEM(ITEM_HOOKSHOT) || CAN_BE_ZORA),
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_BIG_POT_ROOM_LOWER] = RandoRegion{ .name = "Lower Big Pot Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            ...
            CHECK(RC_SWAMP_SKULLTULA_POT_ROOM_POT_01, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_POT_ROOM_POT_02, CAN_KILL_CURSED_SKULLTULA),
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_MONUMENT_ROOM] = RandoRegion{ .name = "Monument Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            CHECK(RC_SWAMP_SKULLTULA_MONUMENT_ROOM_CRATE_01, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_MONUMENT_ROOM_CRATE_02, CAN_KILL_CURSED_SKULLTULA),
    ...
    Regions[RR_SWAMP_SPIDER_HOUSE_TREE_ROOM] = RandoRegion{ .name = "Tree Room", .sceneId = SCENE_KINSTA1,
        .checks = {
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_GRASS_01, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_GRASS_02, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_HIVE, CAN_USE_PROJECTILE),
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_TREE_01, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_TREE_02, CAN_KILL_CURSED_SKULLTULA),
            CHECK(RC_SWAMP_SKULLTULA_TREE_ROOM_TREE_03, CAN_KILL_CURSED_SKULLTULA)
        },
        .connections = {
            CONNECTION(RR_SWAMP_SPIDER_HOUSE_GOLD_ROOM_UPPER, true)
        },
