...
std::unordered_map<RandoItemId, std::tuple<std::function<void()>, std::vector<ActorId>, RandoInf>> soulMap = {
    ...
    { RI_SOUL_DEKU_BABA, { DrawDekuBaba, { ACTOR_EN_DEKUBABA, ACTOR_EN_KAREBABA }, RANDO_INF_OBTAINED_SOUL_OF_DEKU_BABAS } },
    ...
    { RI_SOUL_GARO, { DrawGaroMaster, { ACTOR_EN_JSO2 }, RANDO_INF_OBTAINED_SOUL_OF_GARO_MASTERS } },
