...
typedef enum {
    ...
    RR_GORMAN_TRACK,
    RR_GORON_GRAVEYARD,
    RR_GREATBAY_COAST_OUTSIDE_LAB,
    RR_GREATBAY_COAST_OUTSIDE_PIRATES_FORTRESS,
    RR_GREATBAY_COAST_PIRATES_COVE,
    RR_GREATBAY_COAST,
    RR_GREATBAY_GREAT_FAIRY_FOUNTAIN,
    RR_HONEY_AND_DARLING,
    RR_IKANA_CANYON_CAVE,
    RR_IKANA_CANYON_LOWER,
    RR_IKANA_CANYON_UNDER_WATERFALL,
    ...
    RR_PINNACLE_ROCK,
    RR_PIRATES_FORTRESS_CAPTAIN_ROOM_ENTRANCE,
    RR_PIRATES_FORTRESS_CAPTAIN_ROOM_LOWER,
    ...
    RR_ROMANI_RANCH,
    RR_SAKON_HIDEOUT,
    RR_SECRET_SHRINE_12_HEART,
    RR_SECRET_SHRINE_16_HEART,
    RR_SECRET_SHRINE_4_HEART,
    RR_SECRET_SHRINE_8_HEART,
    RR_SECRET_SHRINE_MAIN_CENTER,
