...
typedef enum {
    ...
    RC_CLOCK_TOWN_SILVER_RUPEE_CHEST,
    ...
    RC_SNOWHEAD_TEMPLE_COMPASS_ROOM_LEDGE,
    RC_SNOWHEAD_TEMPLE_PILLARS_ROOM,
    RC_SNOWHEAD_TEMPLE_CENTRAL_ROOM_ALCOVE,
    RC_SNOWHEAD_TEMPLE_ICICLE_ROOM_ALCOVE,
    RC_SNOWHEAD_TEMPLE_BLOCK_ROOM_LEDGE,
    RC_SNOWHEAD_TEMPLE_CENTRAL_ROOM_BOTTOM,
    RC_SNOWHEAD_TEMPLE_MAP_ALCOVE,
