...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_DOUBLE_DEFENSE,             "",     "Double Defense",             RITYPE_LESSER,          ITEM_NONE,                       GI_NONE,                     GID_HEART_CONTAINER),
    ...
    RI(RI_HEART_CONTAINER,            "a",    "Heart Container",            RITYPE_LESSER,          ITEM_HEART_CONTAINER,            GI_HEART_CONTAINER,          GID_HEART_CONTAINER),
    RI(RI_HEART_PIECE,                "a",    "Heart Piece",                RITYPE_LESSER,          ITEM_HEART_PIECE,                GI_HEART_PIECE,              GID_HEART_PIECE),
