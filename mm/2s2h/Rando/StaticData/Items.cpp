...
std::unordered_map<RandoItemId, RandoStaticItem> Items = {
    ...
    { RI_HOOKSHOT,                { "the Hookshot",                  ITEM_HOOKSHOT,          GI_HOOKSHOT,          GID_HOOKSHOT } },
    ...
    { RI_RECOVERY_HEART,          { "a recovery heart",              ITEM_RECOVERY_HEART,    GI_RECOVERY_HEART,    GID_RECOVERY_HEART } },
