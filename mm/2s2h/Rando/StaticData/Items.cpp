...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_CLOCK_TOWN_MAP,             "the",  "Map of Clock Town",          ITEM_TINGLE_MAP,                 GI_TINGLE_MAP_CLOCK_TOWN,    GID_TINGLE_MAP),
    ...
    RI(RI_GREAT_BAY_MAP,              "the",  "Map of Great Bay",           ITEM_TINGLE_MAP,                 GI_TINGLE_MAP_GREAT_BAY,     GID_TINGLE_MAP),
    ...
    RI(RI_GREAT_BAY_TEMPLE_MAP,       "the",  "Great Bay Temple Map",       ITEM_DUNGEON_MAP,                GI_MAP,                      GID_DUNGEON_MAP),
    ...
    RI(RI_ROMANI_RANCH_MAP,           "the",  "Map of Romani Ranch",        ITEM_TINGLE_MAP,                 GI_TINGLE_MAP_ROMANI_RANCH,  GID_TINGLE_MAP),
    ...
    RI(RI_SNOWHEAD_MAP,               "the",  "Map of Snowhead",            ITEM_TINGLE_MAP,                 GI_TINGLE_MAP_SNOWHEAD,      GID_TINGLE_MAP),
    ...
    RI(RI_SNOWHEAD_TEMPLE_MAP,        "the",  "Snowhead Temple Map",        ITEM_DUNGEON_MAP,                GI_MAP,                      GID_DUNGEON_MAP),
